...
//                 className="w-full h-auto mb-4 border-gray-300"
//               />
//               <div className="absolute bottom-10 transform translate-y-10 bg-white p-4 w-80 shadow-lg group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-in-out">
//                 <h3 className="text-xl font-display">{member.firstname} {member.lastname}</h3>
